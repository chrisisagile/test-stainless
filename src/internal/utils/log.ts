...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: CredexUnity): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: CredexUnity): Logger {
